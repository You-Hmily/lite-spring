    ...
    public Object autowireConstructor(final BeanDefinition bd) {
        ...
        try{
           beanClass=this.beanFactory.getBeanClassLoader().loadClass(bd.getBeanClassName());
            ...
            throw new BeanCreationException(bd.getID(),"Instantiation of bean failed,can't read");
        }
        ...
        try{
            ...
            throw new BeanCreationException(bd.getID(),"can't find a create instance using "+bd.getBeanClassName());
        }
    }
